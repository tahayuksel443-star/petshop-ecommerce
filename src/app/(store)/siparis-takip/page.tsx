...
export default function OrderTrackingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      toast.error(data.error || 'Siparis bulunamadi');
      setOrder(null);
      setLoading(false);
      return;
    }
  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      <div className="card p-8">
        ...
        <p className="mt-2 text-sm text-gray-500">Uyeliksiz verdiginiz siparisleri siparis numarasi ve e-posta ile sorgulayabilirsiniz.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <input
            ...
            required
          />
          <button type="submit" disabled={loading} className="btn-primary md:col-span-2 justify-center py-3">
